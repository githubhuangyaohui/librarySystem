    ...
    <el-drawer :visible.sync="dig"
        ...
        <el-form>
            <el-form-item>
                <div class="dig-item">
                    <span>密码:</span>
                    <el-input show-password v-model="data.password" style="width: 80%"></el-input>
                </div>
            </el-form-item>
            <el-form-item>
                <div class="dig-item">
                    <span>昵称:</span>
                    <el-input style="width: 80%" v-model="data.nickname">{{data.nickname}}</el-input>
                </div>
            </el-form-item>
            <el-form-item>
                <div class="dig-item">
                    <span>邮箱:</span>
                    <el-input style="width: 80%" v-model="data.email">{{data.email}}</el-input>
                </div>
            </el-form-item>
            <el-form-item>
                <div class="dig-item">
                    <span>电话:</span>
                    <el-input style="width: 80%" v-model="data.phone">{{data.phone}}</el-input>
                </div>
            </el-form-item>
            <el-form-item>
                <div class="dig-item">
                    <span>地址:</span>
                    <el-input style="width: 80%" v-model="data.address">{{data.address}}</el-input>
                </div>
            </el-form-item>
            <el-form-item>
                <div class="dig-item">
